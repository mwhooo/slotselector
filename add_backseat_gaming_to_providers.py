#!/usr/bin/env python3
"""
Add Backseat Gaming slots to slot_providers.json
"""
...
# Get list of backseat gaming images
images_dir = Path('public/images')
image_files = {f.name for f in images_dir.glob('backseatgaming-*')}

print(f"Found {len(image_files)} Backseat Gaming images")

# Add to providers
added = 0
for image_file in sorted(image_files):
    if image_file not in providers:
        providers[image_file] = "Backseat Gaming"
        added += 1
